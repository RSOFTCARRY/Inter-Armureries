...
<div class="max-w-4xl mx-auto p-8">
    <h1 class="text-3xl font-bold mb-6">Bienvenue, {{ Auth::user()->raison_sociale ?? Auth::user()->name }} !</h1>
    ...
    <div class="bg-white p-6 rounded shadow-md border border-gray-200">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-700 mb-4">
            <li><strong>Nom de l’entreprise :</strong> {{ Auth::user()->raison_sociale ?? 'Non renseigné' }}</li>
